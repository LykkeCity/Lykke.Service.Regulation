...
namespace Lykke.Service.Regulation.Client.AutorestClient
{
    ...
    public static partial class RegulationAPIExtensions
    {
            ...
            /// The client id.
            /// </param>
            public static ClientMarginRegulationModel ClientMarginRegulationGetByClientId(this IRegulationAPI operations, string clientId)
            {
            ...
            /// </param>
            public static async Task<ClientMarginRegulationModel> ClientMarginRegulationGetByClientIdAsync(this IRegulationAPI operations, string clientId, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The country code.
            /// </param>
            public static RegulationModel RegulationGetMarginByCountry(this IRegulationAPI operations, string country)
            {
                return operations.RegulationGetMarginByCountryAsync(country).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<RegulationModel> RegulationGetMarginByCountryAsync(this IRegulationAPI operations, string country, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.RegulationGetMarginByCountryWithHttpMessagesAsync(country, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
