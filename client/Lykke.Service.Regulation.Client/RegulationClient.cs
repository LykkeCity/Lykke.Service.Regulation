    ...
    public class RegulationClient : IDisposable, IRegulationClient
    {
        ...
        public async Task AddRegulationAsync(RegulationModel model)
        {
            ErrorResponse errorResponse =
                await _service.RegulationAddAsync(new NewRegulationModel(model.Id));
        ...
        {
            ClientMarginRegulationModel result = await _service.ClientMarginRegulationGetByClientIdAsync(clientId);

            return result?.RegulationId;
        }
